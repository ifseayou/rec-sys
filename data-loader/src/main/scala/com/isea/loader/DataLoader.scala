...
object DataLoader {
  val MOVIE_DATA_PATH = "G:\\scala_learn\\recommended-system\\presenter\\data-loader\\src\\main\\resources\\movies.csv"
  val RATING_DATA_PATH = "G:\\scala_learn\\recommended-system\\presenter\\data-loader\\src\\main\\resources\\ratings.csv"
  val TAG_DATA_PATH = "G:\\scala_learn\\recommended-system\\presenter\\data-loader\\src\\main\\resources\\tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 需要将数据保存到MongoDB中，导入的是原始的电影，打分，用户标签数据
